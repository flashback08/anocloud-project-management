...
export default function Sidebar() {
  ...
  const navigationItems = [
    ...
    { label: 'Projects', path: '/projects', icon: 'M3 7v10a2 2 0 002 2h14a2 2 0 002-2V7a2 2 0 002-2H5a2 2 0 00-2 2z' },
    ...
    <aside className="w-64 border-r border-slate-800/60 bg-slate-900/40 backdrop-blur-xl h-screen flex flex-col justify-between p-4 z-20">
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-2 px-2 py-1">
          ...
          <span className="font-mono text-xs font-bold tracking-widest text-slate-300">ANOCLOUD // ENGINE</span>
        </div>
